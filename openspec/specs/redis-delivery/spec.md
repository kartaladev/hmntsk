# redis-delivery Specification

## Purpose

Defines what is specific to publishing task events to a Redis Stream, beyond the contract every bus sink shares: how far the stream may grow, and what trimming it does to the consumer groups reading it.
