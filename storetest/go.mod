module github.com/kartaladev/hmntsk/storetest
...
// real version, when the modules are tagged. Core is tagged before anything
// that depends on it; see the release order in the README.
